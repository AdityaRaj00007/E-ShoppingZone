    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers("/productservice/products/getAllProducts").hasAnyRole("ROLE_CUSTOMER", "ROLE_ADMIN" , "ROLE_MERCHANT")
                        ...
                        .pathMatchers("/orderservice/orders/placeOrder", "/orderservice/orders/customer/**", "/orderservice/orders/cancelOrder/**").hasAnyRole("ROLE_CUSTOMER", "ROLE_ADMIN", "ROLE_MERCHANT")
                        .pathMatchers("orderservice/orders/getAllOrders", "/orderservice/orders/changeOrderStatus/**").hasAnyRole("ROLE_MERCHANT", "ROLE_ADMIN")
                        .pathMatchers("/orderservice/**").hasAnyRole("ROLE_ADMIN" ,"ROLE_MERCHANT")
