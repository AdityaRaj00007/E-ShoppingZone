...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<String> createUser(User user) {
        ...
        try {
            ...
            String emailResponse = notificationClient.sendRegistrationSuccessEmail(user.getEmailId(), user.getFullName());
            System.out.println("Email sent response: " + emailResponse);

        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>("Something went wrong, email could not be sent.", HttpStatus.INTERNAL_SERVER_ERROR);
        }

        return new ResponseEntity<>("User created successfully with UserId " + user.getUserId() + ". Registration success email sent.", HttpStatus.CREATED);
    }
